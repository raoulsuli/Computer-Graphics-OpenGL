...
{	
	translateX = 0;
	translateY += deltaTimeSeconds * speedT;
	
	modelMatrix = glm::mat3(1);
	modelMatrix = modelMatrix * Transform2D::Translate(150, 250);
	modelMatrix *= Transform2D::Translate(translateX, 70 * sin(translateY));
